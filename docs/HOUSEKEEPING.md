...
| H-25 | IN PROGRESS | Balance | LOW | Volley zaps + prism floors + last-stand shifts + C1L7 debut breath built — open: feel pass, beats |
...
| H-35 | TODO | Release | HIGH | Sim fingerprint is near-blind — the battery dies in 4–14s on 40/40 boards, so a late-lane sim change keeps its board id |
