...
| 02 | `02-boss.png` | The boss of **stage 24**, the Prism, wounded (PULSES 2/6), **both rays lit**, a pulse wave landing | Two rays past their birth burst, both emitters alive, the machine at least one pulse down |
...
|---|---|---|---|
| `docs/store/raw/play/` | 1920 x 1080 | 960 x 540 x 2 | Google Play phone screenshots (16:9) |
| `docs/store/raw/iphone/` | 2868 x 1320 | 956 x 440 x 3 | App Store iPhone 6.9" (Apple scales it down for the smaller phones) |
...
1. **Canvas 2D rasters lazily.** With the clock cranked and no compositor frames, 300
   ...
   software raster for good, and a 1920 x 1080 frame then costs 350 ms and not 5 ms.
...
| File | What | Spec |
|---|---|---|
| `run-yt.mp4` | The full run: launch on a two-thumb grip, 77 s of lane, LANE CLEARED | 1920 x 1080, 60 fps, H.264, AAC 256 k, 1:26. For YouTube, then the Play promo video field |
...
4. **Store spec numbers drift.** Check them in Play Console and App Store Connect on the day
   of the upload: Play 16:9 stills from 1920 x 1080 and a 1024 x 500 banner; App Store
