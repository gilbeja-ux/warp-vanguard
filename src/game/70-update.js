...
const INFO_CARDS = {
  ...
  bossArray: { title: 'THE ARRAY', lines: ['It never moves and never shoots.', 'Each arm ARRANGES traffic — read the', 'figure and clear it CLEAN to shear it.', 'Armoured until the arms are gone.'] },
