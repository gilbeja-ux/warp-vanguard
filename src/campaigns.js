...
const CAMPAIGN_PACKAGES = [{
  ...
  levels: [
    { name: 'OMNISERVE CAMPUS', tint: '80,160,255', duration: 40, spawnMin: 1.50, spawnMax: 2.30, speed: 0.34, doubles: 0.00, heavies: 0.00, lines: 0.00, colors: 0.00, track: 0,
      story: { line: 'One line. One payload. Taps already on it.' },
    ...
    { name: 'OLD TOWN GRID', tint: '255,170,90', duration: 50, spawnMin: 1.05, spawnMax: 1.80, speed: 0.40, doubles: 0.30, heavies: 0.22, lines: 0.00, colors: 0.00, track: 1,
      ...
      story: { line: 'Same make, same timing. One operator.' },
    ...
    { name: 'METRO EXCHANGE', tint: '110,230,200', duration: 55, spawnMin: 0.95, spawnMax: 1.70, speed: 0.43, doubles: 0.30, heavies: 0.22, lines: 0.00, colors: 0.00, frags: 0.12, track: 2, bursts: true,
      ...
      story: { line: 'Volleys now, and black traps that fry nodes.' },
    ...
    { name: 'HARBOR CROSSING', tint: '70,205,235', duration: 60, spawnMin: 0.85, spawnMax: 1.55, speed: 0.46, doubles: 0.35, heavies: 0.20, lines: 0.20, colors: 0.00, frags: 0.13, track: 0,
      ...
      story: { line: 'Barrier walls under the harbor mud.' },
    ...
    { name: 'FINANCIAL SPINE', tint: '255,205,80', duration: 65, spawnMin: 0.68, spawnMax: 1.25, speed: 0.48, doubles: 0.42, heavies: 0.18, lines: 0.18, colors: 0.40, frags: 0.16, walls: 0.10, track: 2,
      ...
      story: { line: 'The keyed locks were cut this morning.' },
...
},
{
  ...
  levels: [
    ...
    { name: 'PRECINCT LOOP', tint: '255,160,80', duration: 55, spawnMin: 0.68, spawnMax: 1.20, speed: 0.49, doubles: 0.50, heavies: 0.10, lines: 0.00, colors: 0.00, frags: 0.10, track: 2, bursts: true,
      ...
      story: { line: 'The precinct loop knows who worked that night.' },
    ...
    { name: 'SHELL EXCHANGE', tint: '255,205,90', duration: 60, spawnMin: 0.58, spawnMax: 1.00, speed: 0.55, doubles: 0.55, heavies: 0.12, lines: 0.00, colors: 0.15, frags: 0.12, track: 1, bursts: true,
      ...
      story: { line: 'Eleven shell companies. One drawer.' },
    ...
    { name: 'LAUNDRY LINE', tint: '150,120,255', duration: 65, spawnMin: 0.55, spawnMax: 0.95, speed: 0.57, doubles: 0.55, heavies: 0.10, lines: 0.08, colors: 0.18, frags: 0.14, walls: 0.06, track: 2,
      ...
      story: { line: 'The money washes under the old mint.' },
    ...
    { name: 'BLACKSITE RELAY', tint: '255,90,110', duration: 70, spawnMin: 0.50, spawnMax: 0.90, speed: 0.60, doubles: 0.60, heavies: 0.14, lines: 0.08, colors: 0.18, frags: 0.16, walls: 0.08, track: 0, bursts: true,
      ...
      story: { line: 'A relay on no map, built with real money.' },
    ...
    { name: 'THE PAYMASTER', tint: '255,70,160', duration: 75, spawnMin: 0.48, spawnMax: 0.85, speed: 0.63, doubles: 0.60, heavies: 0.15, lines: 0.10, colors: 0.20, frags: 0.18, walls: 0.08, track: 1, bursts: true,
      ...
      story: { line: 'One retired login signs every invoice.' },
    ...
    { name: 'BADGE ZERO', tint: '212,101,255', duration: 50, spawnMin: 0.70, spawnMax: 1.25, speed: 0.55, doubles: 0.45, heavies: 0.16, lines: 0.10, colors: 0.22, frags: 0.14, walls: 0.08, track: 2, boss: true, bossKind: 'triad',
      ...
      story: { line: 'He built a private core from stolen plans.' },
...
},
{
  ...
  levels: [
    { name: 'DEAD HARBOR', tint: '80,200,215', duration: 55, spawnMin: 1.00, spawnMax: 1.65, speed: 0.48, doubles: 0.30, heavies: 0.18, lines: 0.30, colors: 0.35, frags: 0.10, track: 0,
      ...
      story: { line: 'A whole coastal chain went dark overnight.' },
    ...
    { name: 'THE SHALLOWS', tint: '150,230,120', duration: 65, spawnMin: 0.90, spawnMax: 1.42, speed: 0.52, doubles: 0.35, heavies: 0.22, lines: 0.30, colors: 0.40, frags: 0.16, walls: 0.18, track: 1,
      ...
      story: { line: 'Wrecks everywhere, killed by their own walls.' },
...
},
{
  ...
  levels: [
    { name: 'DECOY RELAY', tint: '255,190,90', duration: 45, spawnMin: 0.90, spawnMax: 1.45, speed: 0.52, doubles: 0.35, heavies: 0.12, lines: 0.10, colors: 0.35, frags: 0.10, track: 0,
      ...
      story: { line: 'He never transmits. So we set out bait.' },
    ...
    { name: 'MIRROR VAULT', tint: '90,200,235', duration: 55, spawnMin: 0.70, spawnMax: 1.18, speed: 0.58, doubles: 0.45, heavies: 0.14, lines: 0.14, colors: 0.50, frags: 0.12, walls: 0.06, track: 2, bursts: true,
      ...
      story: { line: 'He cracked a vault of counterfeit files.' },
    ...
    { name: 'THE APIARY', tint: '255,205,90', duration: 65, spawnMin: 0.52, spawnMax: 0.90, speed: 0.65, doubles: 0.55, heavies: 0.18, lines: 0.20, colors: 0.55, frags: 0.18, walls: 0.12, track: 2, bursts: true,
      ...
      story: { line: 'His hive: every hunter he ever built.' },
    ...
    { name: 'OPEN LINE', tint: '255,90,110', duration: 70, spawnMin: 0.48, spawnMax: 0.82, speed: 0.68, doubles: 0.58, heavies: 0.22, lines: 0.22, colors: 0.50, frags: 0.20, walls: 0.15, track: 0, bursts: true,
      ...
      story: { line: 'To save the hive, he opens a line himself.' },
...
},
{
  ...
  levels: [
    { name: 'INJECTION POINT', tint: '96,180,255', duration: 50, spawnMin: 0.72, spawnMax: 1.20, speed: 0.58, doubles: 0.50, heavies: 0.15, lines: 0.20, colors: 0.30, frags: 0.15, walls: 0.10, track: 0,
      ...
      story: { line: 'No warrant reaches him. Only this virus.' },
    ...
    { name: 'THE GAUNTLET', tint: '255,160,80', duration: 55, spawnMin: 0.60, spawnMax: 1.02, speed: 0.63, doubles: 0.55, heavies: 0.16, lines: 0.22, colors: 0.32, frags: 0.16, walls: 0.12, track: 1, bursts: true,
      ...
      story: { line: 'His defenses hunt the thing in your hands.' },
    ...
    { name: 'FIREWALL DELTA', tint: '120,230,190', duration: 60, spawnMin: 0.54, spawnMax: 0.92, speed: 0.66, doubles: 0.55, heavies: 0.18, lines: 0.26, colors: 0.35, frags: 0.18, walls: 0.18, track: 2,
      ...
      bands: [{ t0: 28, t1: 48, intensity: 1.7 }],
      story: { line: 'He is sealing the virus in a dead segment.' },
